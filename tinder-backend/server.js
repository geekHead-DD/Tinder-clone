...
//Appconfig
const app = express();
const port = process.env.PORT || 3000; // port app gonna listen
const connection_url='mongodb+srv://admin:p9dYXUOsHnFIZYgH@cluster0.nc5u1.mongodb.net/tinderdb?retryWrites=true&w=majority'
//Middlewares
